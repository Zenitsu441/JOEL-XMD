...
const config = {
  SESSION_ID: process.env.SESSION_ID || "JOEL~XMD~bYnt6hcF",
...
// don't use my codes without a permission 🙏
  ...
  DELETED_MESSAGES_CHAT_ID: process.env.DELETED_MESSAGES_CHAT_ID || "233553342652@s.whatsapp.net",
  OWNER_NAME: process.env.OWNER_NAME || "Trending_Boss",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "233553342652",
  SUDO_NUMBER: process.env.SUDO_NUMBER || "233553342652",
